...
import { 
  ...
  Settings, Timer, Wrench, BarChart, Sparkles
} from 'lucide-react';
...
export const EquipmentDetail = ({ id }: EquipmentDetailProps) => {
  ...
  const equipment = {
    ...
    status: 'operational', // operational, maintenance, breakdown, standby
    criticalityLevel: 'high', // low, medium, high
    mtbf: 1240, // hours
    mttr: 3.2, // hours
              ...
              <CardContent className="space-y-2">
                ...
                <div className="grid grid-cols-2 text-sm">
                  ...
                  <span className="font-medium">
                    {format(equipment.installationDate, 'dd/MM/yyyy')}
                  </span>
                </div>
                <div className="grid grid-cols-2 text-sm">
                  <span className="text-muted-foreground">Criticité</span>
                  <span className="font-medium capitalize">
                    {equipment.criticalityLevel === 'high' && 
                      <span className="text-destructive flex items-center">
                        <AlertCircle className="mr-1 h-3 w-3" />
                        Élevée
                      </span>
                    }
                    {equipment.criticalityLevel === 'medium' && 
                      <span className="text-warning flex items-center">
                        Moyenne
                      </span>
                    }
                    {equipment.criticalityLevel === 'low' && 
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <div className="grid grid-cols-2 text-sm">
                  ...
                  <span className="font-medium">
                    {format(equipment.lastMaintenance, 'dd/MM/yyyy')}
                  </span>
                </div>
                <div className="grid grid-cols-2 text-sm">
                  <span className="text-muted-foreground">Prochaine maintenance</span>
                  <span className="font-medium">
                    {format(equipment.nextMaintenance, 'dd/MM/yyyy')}
                    <span className="ml-1 text-xs text-muted-foreground">
                      ({formatDistanceToNow(equipment.nextMaintenance, { addSuffix: true, locale: fr })})
                    </span>
                  </span>
                </div>
                <div className="grid grid-cols-2 text-sm">
                  <span className="text-muted-foreground">MTBF</span>
                  <span className="font-medium">{equipment.mtbf} heures</span>
                </div>
                <div className="grid grid-cols-2 text-sm">
                  <span className="text-muted-foreground">MTTR</span>
                  <span className="font-medium">{equipment.mttr} heures</span>
                </div>
                <div className="grid grid-cols-2 text-sm">
